...
"""
Iteration 10 — weighted hybrid fusion (TF-IDF + MiniLM + SPECTER2).

Goal: keep Iteration 4's strong sparse+dense core while adding SPECTER2 with a
smaller weight instead of equal-weight RRF.
"""
...
def main() -> None:
    ...
    print("Iteration 10 submission generated.")
    print(
        "Method: weighted RRF(tfidf, minilm, specter2) "
        f"weights=({W_TFIDF}, {W_MINILM}, {W_SPECTER2}), k={RRF_K}, depth={FUSION_DEPTH}"
    )
